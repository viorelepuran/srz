...
export type BaseSlotFillContext = {
    ...
    registerFill: (name: SlotKey, instance: FillInstance, children: FillChildren) => void;
    unregisterFill: (name: SlotKey, instance: FillInstance) => void;
    updateFill: (name: SlotKey, instance: FillInstance, children: FillChildren) => void;
};
export {};
