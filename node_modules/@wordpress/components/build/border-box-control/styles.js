...
const wrapper = exports.wrapper = process.env.NODE_ENV === "production" ? {
  name: "bjn8wh",
...
const centeredBorderControl = exports.centeredBorderControl = process.env.NODE_ENV === "production" ? {
  name: "1nwbfnf",
