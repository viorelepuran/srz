...
const PolymorphicDiv = /*#__PURE__*/(0, _base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "e19lxcc00"
} : {
  target: "e19lxcc00",
...
function UnforwardedView({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(PolymorphicDiv, {
    as: as,
    ref: ref,
    ...restProps
  });
 ...
 * ```
 */
const View = exports.View = Object.assign((0, _element.forwardRef)(UnforwardedView), {
