  ...
  RenderModal: ({
    ...
    return /*#__PURE__*/_jsxs(VStack, {
      ...
      children: [/*#__PURE__*/_jsx(Text, {
        ...
        _x('Delete "%s"?', 'template part'), getItemTitle(items[0]))
              ...
              success: {
                messages: {
                  getMessage: item => {
                    ...
                    __('"%s" reset.'), decodeEntities(getItemTitle(item))) : sprintf(/* translators: %s: The template/part's name. */
                    _x('"%s" deleted.', 'template part'), decodeEntities(getItemTitle(item)));
                  },
                  getBatchMessage: () => {
