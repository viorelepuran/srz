 ...
 */
import { Icon, __experimentalHStack as HStack, __experimentalVStack as VStack, __experimentalText as Text, privateApis as componentsPrivateApis } from '@wordpress/components';
...
export default function PostCardPanel({
  ...
  const postIds = useMemo(() => Array.isArray(postId) ? postId : [postId], [postId]);
  const {
    postTitle,
    icon,
    labels
  ...
  if (labels?.name && postIds.length > 1) {
    ...
    __('%i %s'), postId.length, labels?.name);
  } else if (postTitle) {
    ...
    children: [/*#__PURE__*/_jsxs(HStack, {
      ...
      children: [/*#__PURE__*/_jsx(Icon, {
        ...
        children: [/*#__PURE__*/_jsx("span", {
          ...
          children: title
        }), pageTypeBadge && postIds.length === 1 && /*#__PURE__*/_jsx(Badge, {
          children: pageTypeBadge
        })]
      }), postIds.length === 1 && /*#__PURE__*/_jsx(PostActions, {
        postType: postType,
        postId: postIds[0],
        onActionPerformed: onActionPerformed
      })]
    }), postIds.length > 1 && /*#__PURE__*/_jsx(Text, {
      className: "editor-post-card-panel__description",
      children: sprintf(
      // translators: %s: Name of the plural post type e.g: "Posts".
      __('Changes will be applied to all selected %s.'), labels?.name.toLowerCase())
    })]
  });
}
