...
export default function BlockVisibility() {
  ...
  const filteredBlockTypes = allowedBlockTypes.filter(blockType => hasBlockSupport(blockType, 'inserter', true) && (!blockType.parent || blockType.parent.includes('core/post-content')));
  ...
  return /*#__PURE__*/_jsx(BlockManager, {
