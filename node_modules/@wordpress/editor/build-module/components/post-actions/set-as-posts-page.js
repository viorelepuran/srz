...
const SetAsPostsPageModal = ({
  ...
  __('This will replace the current posts page: "%s"'), getItemTitle(currentPostsPage)) : __('This page will show the latest posts.');
  ...
  __('Set "%1$s" as the posts page? %2$s'), pageTitle, modalWarning);
