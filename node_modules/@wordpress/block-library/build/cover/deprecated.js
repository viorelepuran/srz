...
const v2 = {
  ...
  save({
    ...
    const classes = (0, _clsx.default)('wp-block-cover-image', dimRatioToClassV1(dimRatio), overlayColorClass, {
      'has-background-dim': dimRatio !== 0,
      'has-parallax': hasParallax,
      [`has-${contentAlign}-content`]: contentAlign !== 'center'
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      className: classes,
      style: style,
      children: !_blockEditor.RichText.isEmpty(title) && /*#__PURE__*/(0, _jsxRuntime.jsx)(_blockEditor.RichText.Content, {
        tagName: "p",
...
const v1 = {
  ...
  save({
    ...
    const style = backgroundImageStyles(url);
    const classes = (0, _clsx.default)('wp-block-cover-image', dimRatioToClassV1(dimRatio), {
      'has-background-dim': dimRatio !== 0,
      'has-parallax': hasParallax
    }, align ? `align${align}` : null);
