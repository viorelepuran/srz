...
exports.__experimentalReapplyBlockFilters = __experimentalReapplyBlockFilters;
...
exports.reapplyBlockTypeFilters = reapplyBlockTypeFilters;
...
function reapplyBlockTypeFilters() {
  return ({
    ...
    for (const [name, settings] of Object.entries(select.getUnprocessedBlockTypes())) {
      const result = dispatch((0, _processBlockType.processBlockType)(name, settings));
      if (result) {
...
function __experimentalReapplyBlockFilters() {
  (0, _deprecated.default)('wp.data.dispatch( "core/blocks" ).__experimentalReapplyBlockFilters', {
    since: '6.4',
