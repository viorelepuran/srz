...
declare module './base-entity-records' {
    namespace BaseEntityRecords {
        interface PostRevision<C extends Context> {
            /**
...
export type PostRevision<C extends Context = 'view'> = OmitNevers<_BaseEntityRecords.PostRevision<C>>;
//# sourceMappingURL=post-revision.d.ts.map